...
main_exp()
{
    ...
    # OPENAI_API_KEY=${KEY} python run_manual.py --task gsm --num_eval_samples ${NUM_EVAL_SAM} --num_samples ${NUM_SAM} --num_dev ${NUM_DEV}  --run_pred --manual_prompt_id proglm --eval_split ${EVAL} --batch_size 10 --temperature ${TEMPR} --style_template proglm ${FLAG}
    OPENAI_API_KEY=${KEY} python run_manual.py --task gsm --num_eval_samples ${NUM_EVAL_SAM} --num_samples ${NUM_SAM} --num_dev ${NUM_DEV} --run_pred --manual_prompt_id satlm --eval_split ${EVAL} --batch_size 1 --temperature ${TEMPR} --style_template satlm ${FLAG}
}
